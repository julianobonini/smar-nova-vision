    ...
    <Sidebar collapsible="icon" className="border-r-0">
      ...
      <div className="px-3 flex flex-col items-center justify-center overflow-hidden shrink-0 bg-transparent py-2">
        {collapsed ? (
          ...
          <>
            <span className="tracking-tight text-sidebar-foreground shadow-md text-4xl font-sans font-bold rounded-md italic leading-none -mb-1">
              smarnet
            </span>
            <span className="text-[10px] font-semibold tracking-[0.3em] text-sidebar-foreground/70 uppercase">
              I N T R A N E T
            </span>
          </>
        )}
