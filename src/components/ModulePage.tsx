...
import { Search, Filter, Plus, MoreVertical, ChevronLeft, ChevronRight, Edit, Trash2 } from 'lucide-react';
...
export default function ModulePage({ title, columns, data }: ModulePageProps) {
  ...
  return (
    <div className="min-h-screen bg-surface-container-low">
      <TopNav />
      <main className="pt-24 pb-12 max-w-[1600px] mx-auto px-6 lg:px-12">
        {/* Header */}
